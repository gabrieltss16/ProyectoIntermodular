...
El proyecto se inició el 16 de marzo de 2026 y se finalizó el 29 de mayo de 2026. Se ha desarrollado de forma progresiva compatibilizándolo con las prácticas formativas en empresa. La disponibilidad real para el proyecto era de lunes a miércoles con cinco horas diarias, y sábado y domingo con cuatro horas diarias. Los jueves y viernes no era posible dedicar tiempo al proyecto por compromisos laborales. Esta distribución supone una disponibilidad máxima teórica de aproximadamente 23 horas semanales, lo que a lo largo de las 11 semanas de desarrollo equivale a unas 250 horas máximas.

Un factor determinante en la planificación fue que *Flutter* y *Dart* eran tecnologías desconocidas al inicio del proyecto. Como alumno de segundo de DAM, la formación recibida hasta el momento no incluía desarrollo móvil multiplataforma, por lo que fue necesario dedicar una parte significativa del tiempo al aprendizaje autodidacta del *framework* de forma simultánea a la propia implementación. Esto provocó que las primeras semanas fueran especialmente lentas y que el ritmo de desarrollo aumentase de forma progresiva a medida que se iba ganando soltura con el lenguaje y las herramientas.
...
**Hito 1 — Inicio del proyecto y aprendizaje (16–25 de marzo).** Durante la primera semana y media se definió el alcance del proyecto, se creó el repositorio en *GitHub*, se elaboró el diagrama entidad-relación del modelo de datos y se dedicó mucho tiempo al aprendizaje inicial de *Dart* y *Flutter*. La prioridad fue comprender la estructura de un proyecto *Flutter* (carpetas, *widgets*, ciclo de vida) y conseguir que la aplicación se ejecutase correctamente en el emulador. Se crearon las primeras pantallas básicas y se estableció la separación en carpetas (modelos, servicios, pantallas) que se mantendría durante todo el desarrollo.

**Hito 2 — Primera base funcional (26 de marzo – 13 de abril).** En esta fase se implementó la pantalla de inicio, el catálogo inicial de ejercicios y la estructura mínima de navegación. El objetivo era disponer de una aplicación visualmente funcional que pudiera mostrarse en una primera revisión con la tutora, aunque aún no tuviera lógica de negocio completa. Se probó la navegación entre pantallas, la carga de datos desde JSON y la visualización básica de ejercicios por zona.

**Hito 3 — Desarrollo avanzado (14 de abril – 28 de abril).** Esta fue la fase más intensa del proyecto. Se implementaron la autenticación completa (registro, inicio de sesión, verificación de correo, *Google Sign-In*), el sistema de rutinas con persistencia dual, el asistente conversacional con integración de *Azure OpenAI*, la persistencia del historial de chat, las reglas de seguridad de *Firestore*, el perfil de usuario y el modo invitado con restricciones. Se dedicaron varias sesiones a refinar la detección de intenciones del chat y a diseñar el *system prompt* para que las respuestas de la IA fuesen útiles y seguras. También se ajustó la coherencia visual de las pantallas.

**Hito 4 — Pulido y cierre (29 de abril – 29 de mayo).** La última fase se centró en las pruebas completas de la aplicación, la corrección de errores, la integración del logo y los iconos definitivos, la organización del sistema de *assets*, y la preparación de la documentación final. Se revisaron todos los flujos de usuario buscando errores o inconsistencias y se verificó el funcionamiento completo en dispositivo físico.

### 5.3 Diario de trabajo

**Semana 1 (16–23 de marzo) — Arranque y aprendizaje.** Se dedicaron estas primeras sesiones a definir la idea del proyecto, a investigar qué tecnología usar para el desarrollo móvil y a empezar a estudiar la base de *Dart* como lenguaje de programación. Al no haber trabajado nunca con *Flutter*, la curva de aprendizaje inicial fue pronunciada: fue necesario comprender conceptos como *widgets*, *StatelessWidget* vs *StatefulWidget*, el árbol de *widgets* y el sistema de *build*. Se creó el repositorio en *GitHub* con la estructura documental inicial (commit inicial del proyecto). Se estimaron unas 18 horas de trabajo dedicadas casi íntegramente a formación y planificación.

**Semana 2 (24–30 de marzo) — Primeros pasos en Flutter.** Se elaboró el diagrama entidad-relación que serviría como referencia para el modelo de datos. Se inicializó el proyecto *Flutter* dentro de la carpeta `app` y se configuró el entorno de desarrollo (*VS Code*, *Android SDK*, emulador). Se creó la pantalla de inicio (*HomeScreen*) y un pequeño catálogo con las primeras zonas y ejercicios cargados desde un JSON local. La prioridad fue verificar que la aplicación abría correctamente en el emulador y que la navegación básica funcionaba. Mucho tiempo se fue en resolver problemas de configuración del SDK y dependencias. Se estimaron unas 22 horas de trabajo.

**Semana 3 (31 de marzo – 6 de abril) — Estructura y navegación.** Se construyó la estructura de navegación principal con la barra inferior y se implementaron las pantallas de zonas y ejercicios por zona. Se definió la arquitectura de servicios (carpetas `services`, `models`, `screens`) que se utilizaría en el resto del proyecto. Se tomó la decisión de usar un *PageView* para la navegación entre pestañas, lo que evita la recarga de datos al cambiar de sección. El avance fue más lento de lo esperado por la necesidad de aprender a gestionar el estado en *Flutter*. Se estimaron unas 22 horas de trabajo.

**Semana 4 (7–13 de abril) — Preparación de Firebase.** Se dedicó esta semana a investigar e integrar *Firebase* en el proyecto. Se creó el proyecto en la consola de *Firebase*, se configuraron las dependencias en `pubspec.yaml` y se probó la conexión con *Cloud Firestore*. Se estudió la documentación de *Firebase Authentication* para planificar el sistema de registro e inicio de sesión. También se preparó la integración con *Azure OpenAI* para el asistente conversacional, configurando las claves y probando llamadas básicas a la API. Se estimaron unas 20 horas de trabajo.

**Semana 5 (14–20 de abril) — Autenticación y rutinas.** Se implementó la autenticación completa con *Firebase* (registro con correo y contraseña, inicio de sesión, verificación de correo electrónico). Se desarrolló el sistema de rutinas con almacenamiento en *Firestore* y se programó la lógica para crear, editar y duplicar rutinas. Se añadió el perfil de usuario con campos de experiencia y objetivos. Se implementó también el chat con *Azure OpenAI*, incluyendo el diseño del *system prompt* para que las respuestas fueran útiles y contextualizadas al ámbito de la fisioterapia. Se estimaron unas 23 horas de trabajo intensivo.

**Semana 6 (21–27 de abril) — Funcionalidades avanzadas y UX.** Se añadió el inicio de sesión con *Google Sign-In* y la validación del correo electrónico. Se programó la detección de intenciones en el chat para sugerir ejercicios y generar rutinas desde la conversación. Se implementó la persistencia del historial de chat, la normalización de texto y el manejo de errores. Se añadieron las reglas de seguridad de *Firestore* y se mejoró significativamente la interfaz de usuario con transiciones, colores, gradientes y fondos coherentes. Se amplió la base de datos de ejercicios con nuevas zonas (rodilla, hombro, lumbar, cervical, tobillo, cadera, dorsal, codo y muñeca). Se estimaron unas 23 horas de trabajo.

**Semana 7 (28 de abril – 4 de mayo) — Coherencia visual.** Se ajustaron los estilos de texto y la consistencia de los títulos en las distintas pantallas. Se unificaron los tamaños de fuente, los márgenes y los colores para que toda la aplicación se percibiera como un producto visual coherente. Se revisó la gestión de perfiles y se mejoraron las transiciones entre pantallas. Se estimaron unas 20 horas de trabajo.

**Semana 8–9 (5–18 de mayo) — Pruebas y correcciones.** Se realizaron pruebas completas del flujo de usuario en emulador y en dispositivo físico. Se corrigieron errores encontrados en la persistencia del chat, en la navegación del modo invitado y en la validación de formularios. Se verificó que `flutter analyze` no reportase ningún problema. Se realizaron ajustes menores en la lógica de las rutinas predeterminadas y en el comportamiento del modo invitado con restricciones. Se estimaron unas 30 horas de trabajo repartidas en dos semanas.

**Semana 10 (19–25 de mayo) — *Branding* y *assets*.** Se incorporó el logo definitivo de la aplicación y los iconos para la barra de navegación y las distintas secciones. Se implementó un sistema de gestión de *assets* para las imágenes, asegurando la consistencia visual en todas las pantallas. Se realizaron los últimos ajustes en los fondos de los iconos y en la presentación general de la aplicación. Se estimaron unas 20 horas de trabajo.

**Semana 11 (26–29 de mayo) — Documentación y cierre.** Se dedicó esta última semana a la redacción de la memoria del proyecto, la preparación de la presentación de diapositivas, la revisión general del código y la verificación final de todos los flujos de la aplicación. Se realizó una limpieza general del código (*refactoring*) para mejorar la legibilidad y mantenibilidad. Se estimaron unas 12 horas de trabajo.

### 5.4 Horas dedicadas por tipo de tarea (estimación)

| Tipo de tarea | Horas estimadas |
|---|---|
| Aprendizaje inicial de *Flutter* y *Dart* | 35–40 |
| Diseño, arquitectura y configuración de servicios | 20–25 |
| Desarrollo de pantallas y navegación | 40–45 |
| Autenticación, *Firestore* y rutinas | 35–40 |
| Chat con IA, persistencia y seguridad | 30–35 |
| Pruebas, correcciones y *branding* | 35–40 |
| Documentación y memoria | 15–20 |
| **Total estimado** | **210–245** |
